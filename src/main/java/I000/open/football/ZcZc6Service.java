...
public class ZcZc6Service {
	...
	public void getWinningNumber(){
		try {
			...
			String getUrl = httpUrl+"type="+StaticFinalString.FOOTBALL_ZC_ZC6_CAIPIAOKONG+"&uid="+uid+"&openid="+openId;
			...
			if(response.getStatusLine().getStatusCode()==200){//如果状态码为200,就是正常返回
				...
				for (Element child : rowElements) {
					...
					WinningNumber winningNumberOld = 
							commonDao.getWinningNumberByTypeAndTime(StaticFinalString.FOOTBALL_ZC_ZC6_CODE, openTime);
					if(winningNumberOld==null){
						...
						winningNumber.setTypeCode(StaticFinalString.FOOTBALL_ZC_ZC6_CODE);
						winningNumber.setTypeName(StaticFinalString.FOOTBALL_ZC_ZC6_NAME);
